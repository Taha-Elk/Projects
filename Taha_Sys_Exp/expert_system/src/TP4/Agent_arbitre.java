...
public class Agent_arbitre {
	...
	public static Agent_intelligent[] list_joueur=new Agent_intelligent[2];
	...
	public static void Partie(int n_tour,char[][] TicTacToe,Agent_intelligent J1,Agent_intelligent J2) {
		if(n_tour==0) {
		...
		if(n_tour%2==0) {
			list_joueur[0].jouer(programme_principal.BR,TicTacToe,list_joueur[1].getBF());
		}
		else {
			list_joueur[1].jouer(programme_principal.BR,TicTacToe,list_joueur[0].getBF());
		}
		Agent_arbitre.Affichage(TicTacToe);
	}
	
	public static boolean Resultat(char[][] TicTacToe,Agent_intelligent J1,Agent_intelligent J2) {
		if(Gagner(TicTacToe,J1.getSymbol())==true){
			System.out.print(J1.getSymbol());
			System.out.println(" est le gagnant");
			return true;
		}
		if(Gagner(TicTacToe,J2.getSymbol())==true){
			System.out.print(J2.getSymbol());
			System.out.println(" est le gagnant");
			return true;
		}	
